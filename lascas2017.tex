...
%
% paper title
\title{ Reconstruction of The Rotation Matrix in Quaternions with an Optimal Observer within a Navigation Algorithm Based on Nonlinear Observers SO(3)}
